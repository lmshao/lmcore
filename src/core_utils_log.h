...
#ifndef LMSHAO_CORE_UTILS_LOG_H
#define LMSHAO_CORE_UTILS_LOG_H
...
#define CORE_UTILS_LOG_TIME_STR                                                                                        \
    ([]() -> const char * {                                                                                            \
...
#define COREUTILS_LOGD(fmt, ...)                                                                                       \
    printf("%s [DEBUG] %s:%d  %s() " fmt "\n", CORE_UTILS_LOG_TIME_STR, FILENAME_, __LINE__, FUNC_NAME_, ##__VA_ARGS__)
#define COREUTILS_LOGW(fmt, ...)                                                                                       \
    printf(COLOR_YELLOW "%s [WARN] %s:%d %s() " fmt "\n" COLOR_RESET, CORE_UTILS_LOG_TIME_STR, FILENAME_, __LINE__,    \
